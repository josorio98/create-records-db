<?php
$cod_cond = $_REQUEST["cod_cond"];
$nom_cond = $_REQUEST["nom_cond"];
$tel_cond = $_REQUEST["tel_cond"];
...
$sql = "INSERT INTO conductores (cod_cond,nom_cond,tel_cond,nit_emp) values('$cod_cond','$nom_cond','$tel_cond','$nit_emp');";
      ...
      <form action="/frm_conductores.php" method="post">
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="nit_emp" placeholder="Seleccione">>
            ...
            ?>
            <option value="<?php echo $empresas[$i]["nit_emp"]?>">
